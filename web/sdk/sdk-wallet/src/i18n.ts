export default {
  addFundsDesc:
    "There are multiple ways to add funds to your browser wallet. If you already have Ethereum or Wrapped Ethereum, simply transfer to your Nova wallet's public address. If you do not already have Ethereum, you can purchase some from a variety of platforms. We've linked a few for your convenience.",
  done: "Done",
  ...
  create: "Create",
  createConfirm: [
    "I understand that my funds are held securely on this browser and not by Nova Wallet.",
